...
- [AUTO_HEBERGEMENT.md](AUTO_HEBERGEMENT.md) — D'un déploiement à un produit installable : ce que change le passage à l'auto-hébergement (modèle de menace, capacités optionnelles, licence copyleft réseau, sauvegarde comme fonctionnalité), **et ce que l'implémentation a appris** — dont la forme qui revient : quelque chose réussit alors que rien ne marche (parcours 28)
